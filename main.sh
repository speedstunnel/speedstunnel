...
TIMESX="10"
CHATIDX="1962241851"
KEYX="6866097221:AAFdDsbTF-R7_d07ewI3z0BQHYrd7hhA"
URLX="https://api.telegram.org/bot$KEY/sendMessage"
clear
...
clear;clear;clear
echo -e " ${CYAN} ┌─────────────────────────────────────────────────┐${NC}" 
echo -e " ${CYAN} │ ${BG_RED}                CAPMODZSTORE                   ${NC} ${CYAN}│$NC"
echo -e " ${CYAN} └─────────────────────────────────────────────────┘${NC}"
echo ""
...
clear
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/speedstunnel/izin/main/ip | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/speedstunnel/izin/main/ip | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
...
Exp1=$(curl https://raw.githubusercontent.com/speedstunnel/izin/main/ip | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
echo -e "\e[32mloading...\e[0m"
clear
REPO="https://raw.githubusercontent.com/speedstunnel/speedstunnel/main/"
start=$(date +%s)
secs_to_human() {
...
clear
restart_system() {
USRSC=$(wget -qO- https://raw.githubusercontent.com/speedstunnel/izin/main/ip | grep $ipsaya | awk '{print $2}')
EXPSC=$(wget -qO- https://raw.githubusercontent.com/speedstunnel/izin/main/ip | grep $ipsaya | awk '{print $3}')
...
clear
print_install "Core Xray 5.8 Latest Version"
...
print_success "Core Xray 5.8 Latest Version"
clear
...
wget raw.githubusercontent.com/arivpnstores/v3/main/files/limit.sh && chmod +x limit.sh && ./limit.sh
cd
...
wget -O /tmp/menu "${REPO}Features/menu/menu"
...
wget ${REPO}files/crontap
mv crontap /etc/crontab
wget https://raw.githubusercontent.com/speedstunnel/speedstunnel/main/menu.zip
unzip menu.zip
chmod +x menu/*
...
clear
echo -e "\e[94;1m╔═════════════════════════════════════════════════╗\e[0m"
echo -e "\e[96;1m             ----[ CAPMODZSTORE ]----                   \e[0m"
echo -e "\e[94;1m╚═════════════════════════════════════════════════╝\e[0m"
echo ""
echo -e "\e[95;1m  Tele : t.me/CapModzStoreTunnneling \e[0m"
echo -e "\e[94;1m╔═════════════════════════════════════════════════╗\e[0m"
...
echo -e " \e[93;1m•\e[0m NOBVPNS = MULTIPORT / WS / TLS (support Apk Noobvpn) "
echo -e ""
echo -e "\e[94;1m╔═════════════════════════════════════════════════╗\e[0m"
